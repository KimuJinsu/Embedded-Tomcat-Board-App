...
![alt text](./image/스크린샷 2024-10-18 오전 10.41.57.png)
##### 작성자 '김진수8'의 게시글 검색 기능
![alt text](./image/스크린샷 2024-10-18 오전 10.42.20.png)
...
![alt text](./image/스크린샷 2024-10-18 오전 10.47.30.png)
...
![alt text](./image/스크린샷 2024-10-18 오전 11.44.12-1.png)
##### 댓글 제출
![alt text](./image/스크린샷 2024-10-18 오전 11.44.37-1.png)
- **댓글 조회**: 게시물에 달린 모든 댓글을 조회하여 사용자와 함께 표시할 수 있습니다.
#### 실행 화면
##### 게시물에 달린 모든 댓글이 목록으로 표시되며, 각 댓글의 작성자와 내용이 함께 나타납니다.
![alt text](./image/스크린샷 2024-10-18 오후 12.00.46-1.png)
...
![alt text](./image/스크린샷 2024-10-18 오전 11.45.04.png)
##### 수정된 댓글이 성공적으로 저장된 후, 수정된 내용이 게시물에 반영됩니다.
![alt text](./image/스크린샷 2024-10-18 오전 11.45.18.png)

#### 실행 화면
##### 댓글 삭제 버튼을 눌러 댓글을 삭제하는 화면입니다.
![alt text](./image/스크린샷 2024-10-18 오전 11.46.27-1.png)
##### 댓글이 삭제된 후, 댓글 목록에서 해당 댓글이 사라진 것을 확인할 수 있습니다.
![alt text](./image/스크린샷 2024-10-18 오전 11.46.34-1.png)
#### 연관 관계:
